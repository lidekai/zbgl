(function( window, $, undefined ) {
	...
	$.elastislide.prototype 	= {
		...
		_configure			: function() {
			...
			// the ul's parent's (div.menu-wrap) width is the "visible" width
		...
		_setCurrentValues	: function() {
			...
			// the ul parent's (div.menu-wrap) width is the "visible" width
			this.visibleWidth	= this.$esCarousel.width();
		...
		_addControls		: function() {
			...
			this.$navNext	= $('<span class="top-nav-next">Next</span>');
			this.$navPrev	= $('<span class="top-nav-prev">Previous</span>');
			$('<div class="top-nav"/>')
			.append( this.$navPrev )
			.append( this.$navNext )
			.appendTo( this.$el );
