...
function kt_getContent(msg){
	return '<div style="margin:20px;font-size:16px;">' + msg + "</div>";
}
function kt_alert(msg){
	$.weeboxs.open(kt_getContent(msg), {title:'提示', type:'alert'});
}
function kt_comfirm(msg, f_ok){
	$.weeboxs.open(kt_getContent(msg),{title:'提示',onok:function(box){f_ok();box.close();}});
}
